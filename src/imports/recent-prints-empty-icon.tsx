...
export function RecentPrintsEmptyIcon({ className }: { className?: string }) {
  const id = useId();
  const clipId = `clip0-recentprints-empty-${id.replace(/:/g, "")}`;
  const maskId = `mask0-recentprints-empty-${id.replace(/:/g, "")}`;
  ...
  return (
    ...
    >
      <g clipPath={`url(#${clipId})`}>
        ...
        <g mask={`url(#${maskId})`}>
          <path
            d="M11.9996 13.3008C11.8696 13.3008 11.7396 13.2708 11.6196 13.2008L2.7896 8.09083C2.4396 7.88083 2.3096 7.42083 2.5196 7.06083C2.7296 6.70083 3.1896 6.58083 3.5496 6.79083L11.9996 11.6808L20.3996 6.82083C20.7596 6.61083 21.2196 6.74083 21.4296 7.09083C21.6396 7.45083 21.5096 7.91083 21.1596 8.12083L12.3896 13.2008C12.2596 13.2608 12.1296 13.3008 11.9996 13.3008Z"
            fill="currentColor"
          />
          <path
